        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowMessagesFromAnyone = table.Column<bool>(type: "bit", nullable: false),
                    AllowTagging = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnFollow = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnLike = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnComment = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnMention = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade); // Cascade for UserId
                    table.ForeignKey(
                        name: "FK_Comments_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction); // No Action for PostId
                });
